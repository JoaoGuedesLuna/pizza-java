...
/**
 * Este painel permite ao usuário que ele visualize seus dados da conta e se quiser mude sua senha.
 *
 * @author João Guedes.
 */
public final class AccountDataFrame extends NavigationFrame {
    
    public AccountDataFrame() {
        super();
        this.initComponents();
        this.renderUserImage();
        this.renderUserName();
        this.limitTextFields();
        this.emailField.setText(super.getAccount().getEmail());
    ...
    private void initComponents() {
        ...
        confirmPasswordLbl.setText("Confirmar nova senha");
        ...
        confirmPasswordField.setMaximumSize(new java.awt.Dimension(302, 32));
        confirmPasswordField.setMinimumSize(new java.awt.Dimension(302, 32));
        confirmPasswordField.setPreferredSize(new java.awt.Dimension(302, 32));
        ...
        cancelLbl.setMaximumSize(new java.awt.Dimension(302, 32));
        cancelLbl.setMinimumSize(new java.awt.Dimension(302, 32));
        cancelLbl.setOpaque(true);
        cancelLbl.setPreferredSize(new java.awt.Dimension(302, 32));
        ...
        editLbl.setForeground(new java.awt.Color(255, 233, 18));
        ...
        editLbl.setMaximumSize(new java.awt.Dimension(302, 32));
        editLbl.setMinimumSize(new java.awt.Dimension(302, 32));
        editLbl.setOpaque(true);
        editLbl.setPreferredSize(new java.awt.Dimension(302, 32));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, rightPanelLayout.createSequentialGroup()
                ...
                .addGroup(rightPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(rightPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(rightPanelLayout.createSequentialGroup()
                            .addComponent(passwordLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(0, 0, 0)
                        ...
                        .addGroup(rightPanelLayout.createSequentialGroup()
                            .addComponent(confirmPasswordLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(0, 0, 0)
                    ...
                    .addComponent(cancelLbl, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(editLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(158, 158, 158))
        );
        rightPanelLayout.setVerticalGroup(
            ...
            .addGroup(rightPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cancelLbl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    protected void changeToDefaultStatus() {
        String password = super.getAccount().getPassword();
        Set.setLineBorder(NavigationFrame.BORDER_DEFAULT_COLOR, this.passwordField, this.confirmPasswordField);
        Set.setText(password, this.passwordField, this.confirmPasswordField);
        Set.setText("", this.passwordWarningLbl, this.confirmPasswordWarningLbl);
        Set.setCursor(Cursor.DEFAULT_CURSOR, this.passwordField, this.confirmPasswordField);
        Set.setFocusable(false, this.passwordField, this.confirmPasswordField);
        Set.setEditable(false, this.passwordField, this.confirmPasswordField);
        Set.setVisible(false, this.confirmPasswordLbl, this.confirmPasswordWarningLbl, this.confirmPasswordField, this.cancelLbl);
        this.editLbl.setText("Editar");
    }
    
    @Override
    protected void changeToEditStatus() {
        Set.setCursor(Cursor.TEXT_CURSOR, this.passwordField, this.confirmPasswordField);
        Set.setFocusable(true, this.passwordField, this.confirmPasswordField);
        Set.setEditable(true, this.passwordField, this.confirmPasswordField);
        Set.setVisible(true, this.confirmPasswordLbl, this.confirmPasswordWarningLbl, this.confirmPasswordField, this.cancelLbl);
    ...
    private boolean passwordSizeIsInvalid() {
        return Data.textFieldSizeIsInvalid(this.passwordField, this.passwordWarningLbl, String.valueOf(this.passwordField.getPassword()),
                "senha", Data.FEMALE_TEXT_FIELD,  6, 15, NavigationFrame.BORDER_DEFAULT_COLOR);
    }
    ...
    private Account getAccountTyped() {
        ...
        accountTyped.setId(super.getAccount().getId());
        accountTyped.setEmail(super.getAccount().getEmail());
    ...
    private void updateData() {
        if (this.passwordSizeIsInvalid() || this.confirmPasswordIsInvalid()) {
            return;
        }
        Account accountTyped = this.getAccountTyped();
        try {
            FactoryDAO.createAccountDAO().save(accountTyped);
            super.setAccount(accountTyped);
            this.changeToDefaultStatus();
            JOptionPane.showMessageDialog(this, "Senha alterada com sucesso!", "Dados da conta", JOptionPane.INFORMATION_MESSAGE);
        }
        catch (DataBaseException dbe) {
            this.changeToDefaultStatus();
            JOptionPane.showMessageDialog(this, "Desculpe, não foi possível atualizar sua senha. Verifique sua conexão.",
    ...
    private void passwordFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_passwordFieldKeyTyped
        if (!this.passwordWarningLbl.getText().isEmpty() && !this.passwordWarningLbl.getText().equalsIgnoreCase("senhas diferentes")) {
            Set.setLineBorder(NavigationFrame.BORDER_DEFAULT_COLOR, this.passwordField);
            this.passwordWarningLbl.setText("");
        }
    ...
    private void confirmPasswordFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_confirmPasswordFieldKeyTyped
        if (!this.confirmPasswordWarningLbl.getText().isEmpty()) {
            Set.setLineBorder(NavigationFrame.BORDER_DEFAULT_COLOR, this.confirmPasswordField);
    ...
    private void editLblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editLblMouseClicked
        if (editLbl.getText().equalsIgnoreCase("editar")) {
